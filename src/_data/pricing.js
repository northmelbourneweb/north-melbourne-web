module.exports = {
    monthly: [
      ...
      },
      {
        ...
        price: "$479",
        description: "Ideal for growing businesses needing advanced features and enhanced SEO.",
        features: [
      ...
      },
      {
        ...
        features: [
          "Includes all features of the Standard Plan.",
            "E-commerce integration (WooCommerce or Shopify).",
            "Product catalog setup for up to 50 products.",
            "Payment gateway integration.",
            "Shopping cart and checkout setup.",
            "Product SEO (title tags, meta descriptions, schema markup).",
        ]
      },
      {
        plan: "SaaS Plan",
